...
async function getSongs(folder) {
    ...
    //Attache a a event listiner to each songs
...
async function main() {
    ...
    // Attetch an eventlistner to play ,next and privous
    ...
    //Add an event Listiner to seekbar 
    ...
    // Add event linstiner for hamburger
    document.querySelector(".hamburger").addEventListener("click", () => {
        document.querySelector(".left").style.left = "0"
    })


    // Add event linstiner for close
    document.querySelector(".close").addEventListener("click", () => {
        document.querySelector(".left").style.left = "-120%"
    })

    //Add an event Listiner To privious and Next
